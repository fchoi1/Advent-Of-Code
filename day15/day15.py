...
class Beacon():
    ...
    def merge_intervals(self, intervals: List[List[int]], new_interval: List[int]) -> List[List[int]]:
            i = 0
    ...
    def checkSensors(self, useLimits: bool = False, minX: int = 0, maxX: int = 0, row: int = -1) -> None:
    ...
    def findSingleBeacon(self, x : int = 20, y : int = 20) -> int:
        ...
        return  hiddenBeacon[0]*4000000+hiddenBeacon[1]
