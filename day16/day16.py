...
class Valves():
    def getInput(self) -> Tuple[dict, dict]:
    ...
    def simpify(self, valves: dict, tunnels: dict):
        dists = {}
    ...
    def getMaxRate(self, timeLength: Optional[int] = 30):
    ...
    def getMaxRate2(self, timeLength: Optional[int] = 26):
        start_time = time.time()
